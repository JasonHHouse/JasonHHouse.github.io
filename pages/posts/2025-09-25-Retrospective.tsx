  ...
  return (
    <div>
      ...
      <div className="post">
        ...
        <img src="/img/retrospective.png" alt="Monthly retrospective meeting with team members reflecting on progress and planning next steps" style={{ width: '100%', height: 'auto', margin: '1rem 0' }} />
